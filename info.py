...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", """<b>ɴᴀᴍᴇ: <code>{file_name}</code> \n\n{file_caption}\n\n⚠️ <b>Warning:</b> This file will be deleted automatically after 5 hours due to copyright. Please make sure to download it or forward it to your saved messages!\n\nJᴏɪɴ Nᴏᴡ: [FilmX](https://t.me/filmxhub20)</b>""")
