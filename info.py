...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", """<b>{file_caption}\n\n⚠️ Heads up: this file auto-deletes in 5 hours (copyright reasons), so grab it now — download it or forward it to your Saved Messages before it's gone!\n\n🇲🇲 ⚠️ သတိပေးချက်: မူပိုင်ခွင့်စည်းမျဉ်းအရ ဒီဖိုင်ကို ၅ နာရီအတွင်း အလိုအလျောက် ဖျက်ပစ်ပါမယ်။ အချိန်မီ Download လုပ်ထားပါ၊ ဒါမှမဟုတ် Saved Messages ထဲကို forward လုပ်ထားဖို့ မမေ့ပါနဲ့နော်! 😊</b>""")
